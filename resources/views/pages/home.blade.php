...
<div class="page-header header-filter header-small" data-parallax="true" style="background-image: url(&quot;images/office.jpg&quot;); transform: translate3d(0px, 0px, 0px);">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				<h2 class="title">Bienvenue sur le site des assos de l'ENSC !</h2>
			</div>
		</div>
	</div>
</div>
	    	...
	    	<div class="section text-center">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h2 class="title">Ce que vous trouverez sur ce site</h2>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="info">
								...
								<h4 class="info-title">Des Assos</h4>
						...
						<div class="col-md-4">
							<div class="info">
								...
								<h4 class="info-title">Des événements</h4>
								<p>Divide details about your product or agency work into parts. Write a few lines about each one. A paragraph describing a feature will be enough.</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="info">
								...
								<h4 class="info-title">Des articles</h4>
								<p>Divide details about your product or agency work into parts. Write a few lines about each one. A paragraph describing a feature will be enough.</p>
							</div>
						</div>
	                </div>
							...
							<div class="card card-profile card-plain">
								<div class="col-md-5">
									<div class="card-image">
										<a href="#pablo">
											<img class="img" src="http://lorempixel.com/600/600/cats/">
										</a>
									<div class="colored-shadow" style="background-image: url(&quot;http://lorempixel.com/600/600/cats/&quot;); opacity: 1;"></div></div>
								</div>
								<div class="col-md-7">
