...
exports.default = {
  ...
  postCommentEvenement: function postCommentEvenement(data) {
    return _vue2.default.http.post('/api/comments', data);
  }
};
...
var _userServices = require('./front/user.services.js');
...
_userServices2.default.getCurrentUser().then(function () {
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.reload("data-v-446cc0d2", __vue__options__)
  }
})()}
...
exports.default = {
  ...
  created: function created() {
    ...
    console.log(_userServices2.default);
    _userServices2.default.getCurrentUser();
  },

  methods: {
    getEvenement: function getEvenement(idEvenement) {
      var vm = this;
      return _evenementServices2.default.show(vm.$route.params.id).then(function (response) {
    ...
    getComments: function getComments() {
      var vm = this;
      return _evenementServices2.default.getCommentsEvenement(vm.evenement.id).then(function (response) {
    ...
    postComment: function postComment() {
      ...
      console.log(_userServices2.default.currentUser);
      if (_userServices2.default.currentUser == null) {
        ...
        return _evenementServices2.default.postCommentEvenement(data).then(function (response) {
          vm.commentText = '';
          vm.getComments();
        });
      }
...
exports.default = {
  ...
  getCurrentUser: function getCurrentUser() {
    ...
    var vm = this;
    return _vue2.default.http.get('/api/user').then(function (data) {
      if (data.body != "") {
